/* $Id: undo.c,v 1.1.1.1 2006/04/10 22:05:23 tim Exp $ */
...
RCSID("$Id: undo.c,v 1.1.1.1 2006/04/10 22:05:23 tim Exp $");
...
UndoMirror (UndoListTypePtr Entry)
{
  ...
  Message ("hace: Internal error, undo mirror on object type %d\n", type);
  return (False);
}
