/* $Id: dev_rs274x.c,v 1.2 2006/06/20 17:49:05 tim Exp $ */
...
RCSID("$Id: dev_rs274x.c,v 1.2 2006/06/20 17:49:05 tim Exp $");
...
GBX_Preamble (PrintInitTypePtr Flags, char *Description)
{
  ...
  if ((strcmp (Description, "drill information") == 0) ||
	(strcmp (Description, "plugged via information") == 0))
    {
