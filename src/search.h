 ...
 *
 *  RCS: $Id: search.h,v 1.1.1.1 2006/04/10 22:05:23 tim Exp $
 */
...
Boolean IsLineInDiagonalPad (PadTypePtr , LineTypePtr);
Boolean IsArcInDiagonalPad (PadTypePtr , ArcTypePtr);
