/* $Id: djopt.c,v 1.2 2006/06/14 08:05:01 eric Exp $ */
...
RCSID("$Id: djopt.c,v 1.2 2006/06/14 08:05:01 eric Exp $");
...
int autorouted_only = 1;

int route_debumpify = 0;	/* eliminate 'U' shape traces */
int route_orthopull = 0;	/* reduce total trace length */
int route_unjaggy = 0;		/* reduce corners */
int route_miter = 0;		/* miter corners */
int route_simple = 0;		/* simple optimizations */
int route_via_nudge = 0;	/* eliminate vias if possible */
int route_via_trim = 0;		/* reduce number of vias */
int route_auto = 0;		/* do all except simple, miter */
