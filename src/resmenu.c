/* $Id: resmenu.c,v 1.1.1.1 2006/04/10 22:05:23 tim Exp $ */
...
#include "check_icon.xbm"

RCSID("$Id: resmenu.c,v 1.1.1.1 2006/04/10 22:05:23 tim Exp $");
...
void
ActionExecuteAction (Widget w, XEvent * e, String * argv, Cardinal * argc)
{
  Tk_Window tkwind = (Tk_Window)w;
}

void
ActionExecuteFile (Widget w, XEvent * e, String * argv, Cardinal * argc)
{
  Tk_Window tkwind = (Tk_Window)w;
}
