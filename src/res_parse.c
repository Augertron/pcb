/* A Bison parser, made from /home/tim/src/pcb-3.0.0/src/res_parse.y
   by GNU bison 1.35.  */
...
RCSID("$Id: res_parse.c,v 1.1.1.1 2006/04/10 22:05:23 tim Exp $");
...
{
       0,     0,     1,     4,     5,    10,    13,    14,    16,    20,
      22,    26,    28
};
static const short yyrhs[] =
{
      -1,     9,    12,     0,     0,    11,     5,    12,     6,     0,
      13,    12,     0,     0,     3,     0,     3,     7,     3,     0,
      10,     0,     3,     7,    10,     0,     4,     0,     1,     0
};
...
{
  "$", "error", "$undefined.", "STRING", "INCLUDE", "'{'", "'}'", "'='", 
  "top_res", "@1", "res", "@2", "res_item_zm", "res_item", 0
};
#endif
...
{
  -32768,     7,-32768,    -5,-32768,-32768,     4,-32768,     0,    17,
      12,-32768,-32768,-32768,     8,-32768,    22,    23,-32768
};

static const short yypgoto[] =
{
  -32768,-32768,    15,-32768,    11,-32768
};
...
{
      -6,     2,     9,     3,     4,    -3,    -6,    -6,     2,    10,
       3,     4,    -3,     2,    15,     3,     4,    -3,    -6,    11,
      12,    14,    17,    18,    13
};
...
case 11:
#line 73 "res_parse.y"
{ resource_do_include(current_res, yyvsp[0].sval); }
    break;
}
