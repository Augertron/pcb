/* $Id: file.c,v 1.2 2006/11/05 17:55:34 tim Exp $ */
...
RCSID("$Id: file.c,v 1.2 2006/11/05 17:55:34 tim Exp $");
...
LoadPCB (char *Filename)
{
  ...
  /* file existence checked before LoadPCB called */
...
WritePCBDataHeader (FILE * FP)
{
  ...
  fprintf (FP, "DRC[%i %i %i %i %i %i]\n", Settings.Bloat, Settings.Shrink,
	   Settings.minWid, Settings.minSlk, Settings.minDrill,
	   Settings.minWid); /* Use min width for min ring for now */
