 ...
 *
 *  RCS: $Id: const.h,v 1.2 2006/06/20 16:41:32 tim Exp $
 */
...
#define ONSILKFLAG              0x0400  /* old flag to indicate silk */
...
#define EDGE2FLAG               0x4000  /* Padr.Point2 closer to outside edge */
					/* also pinout text is vertical */
#define PLUGFLAG		0x8000  /* pin or via is plugged */
