/* $Id: dev_ps.c,v 1.1.1.1 2006/04/10 22:05:23 tim Exp $ */
...
RCSID("$Id: dev_ps.c,v 1.1.1.1 2006/04/10 22:05:23 tim Exp $");
  ...
  if (TEST_FLAG (SQUAREFLAG, Pad))
	...
	else
	{
		...
		polygon = CreateNewPolygonFromPad (CURRENT, Pad->Point1.X,
				...
				scrunch, CLEARPOLYFLAG);
		PS_PrintPolygon(polygon);
