/* $Id: control.c,v 1.1.1.1 2006/04/10 22:05:23 tim Exp $ */
...
RCSID("$Id: control.c,v 1.1.1.1 2006/04/10 22:05:23 tim Exp $");

/* ---------------------------------------------------------------------------
 * include bitmap data
 */
#include "mode_icon.xbm"
...
void PushOnTopOfLayerStack (int);
