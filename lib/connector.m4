...
# 
#   RCS: $Id: connector.m4,v 1.1.1.1 2006/04/10 22:05:22 tim Exp $
#
define(`Description_connector2', `connector 2x1 pins')
define(`Param1_connector2', 1)
define(`Param2_connector2', 2)

define(`Description_connector4s', `connector 4x1 pins')
define(`Param1_connector4s', 1)
define(`Param2_connector4s', 4)

define(`Description_connector4', `connector 2x2 pins')
define(`Param1_connector4', 2)
define(`Param2_connector4', 2)

define(`Description_connector6s', `connector 6x1 pins')
define(`Param1_connector6s', 1)
define(`Param2_connector6s', 6)
...
define(`Description_DIN41_651_32lay', `DIN41.651 laying 32 pins')
define(`Param1_DIN41_651_32lay', 32)

define(`Description_DIN41_651_32stand', `DIN41.651 standing 32 pins')
define(`Param1_DIN41_651_32stand', 32)
