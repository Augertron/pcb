 ...
 *
 *  RCS: $Id: globalconst.h,v 1.3 2006/06/15 18:38:16 tim Exp $
 */
...
#define SCROLL_TIME 		200		/* time between scrolls when drawing beyond border */
...
#define	MIN_PINORVIASIZE	200	/* size of a pin or via in centimils */
#define	MIN_PINORVIAHOLE	100	/* size of a pins or vias drilling hole */
#define	MAX_PINORVIASIZE	40000
#define	MIN_PINORVIACOPPER	100	/* min difference outer-inner diameter */
#define	MIN_PADSIZE		200	/* size of a pad */
